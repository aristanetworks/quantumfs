...
vet: $(PKGS_TO_TEST) $(COMMANDS)
	go vet `find . -path ./vendor -prune -o -path ./.git -prune -o -path ./utils/dangerous -prune -o -path ./QFSClient -prune -o -path ./QubitCluster -prune -o -path ./configs -prune -o -path ./_helpers -prune -o -path ./cmd -true -o -type d -print`
