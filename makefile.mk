...
TEST_PKGS_TO_COMPILE=longrunningtests
...
$(TEST_PKGS_TO_COMPILE):
	sudo -E go test -c -tags longrunningtests -gcflags '-e' github.com/aristanetworks/quantumfs/backends/cql -o longrunningcql.test
