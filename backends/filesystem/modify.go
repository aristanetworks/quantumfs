...
func (b *fileStore) Insert(c ether.Ctx, key []byte, value []byte, metadata map[string]string) error {
...
func (b *fileStore) Delete(c ether.Ctx, key []byte) error {
	keyHex := hex.EncodeToString(key)
...
func (b *fileStore) Update(c ether.Ctx, key []byte,
