...
func (suite *wsdbCacheTestSuite) TestCacheAfterEmptyDB() {
	...
	suite.Require().Contains(nsList, quantumfs.NullSpaceName,
	...
	suite.Require().Equal(map[string]quantumfs.WorkspaceNonce{
		quantumfs.NullSpaceName: quantumfs.WorkspaceNonceInvalid}, wsMap,
...
func (suite *wsdbCacheTestSuite) TestCacheWithRemoteInserts() {
	...
	nsRows := mockDbRows{[]interface{}{quantumfs.NullSpaceName},
		[]interface{}{"remoteNS"}}
	nsIter := new(MockIter)
	...
	mockWsdbCacheWorkspaceFetch(suite.common.mockSess, wsRows, wsVals,
		wsIter, nil)
	nonce := quantumfs.WorkspaceNonce{Id: 5, PublishTime: 0xbeef}
...
func (suite *wsdbCacheTestSuite) TestCacheAfterBranching() {
	...
	mockBranchWorkspace(suite.common.mockSess, quantumfs.NullSpaceName,
		quantumfs.NullSpaceName, quantumfs.NullSpaceName,
		"ts1", "ns1", "ws1",
		[]byte(nil), quantumfs.WorkspaceNonceInvalid, gocql.ErrNotFound)
...
func (suite *wsdbCacheTestSuite) TestCacheConcInsertsRefresh() {
	...
	var wsMap map[string]quantumfs.WorkspaceNonce
	...
	mockWsdbCacheWorkspaceFetch(suite.common.mockSess, wsRows, wsVals,
		wsIter, wsFetchPause)
	nonce := quantumfs.WorkspaceNonce{Id: 7, PublishTime: 0xbeef}
...
func (suite *wsdbCacheTestSuite) TestCacheConcDeletesRefresh() {
	...
	suite.Require().Contains(wsMap, quantumfs.NullSpaceName,
...
func (suite *wsdbCacheTestSuite) TestCacheSameInsDelDuringRefresh() {
	...
	mockWsdbKeyGet(suite.common.mockSess, quantumfs.NullSpaceName,
		quantumfs.NullSpaceName, quantumfs.NullSpaceName, []byte(nil),
		quantumfs.WorkspaceNonceInvalid, nil)
	nonce := quantumfs.WorkspaceNonce{Id: 9, PublishTime: 0xbeef}
	mockWsdbKeyGet(suite.common.mockSess, quantumfs.NullSpaceName,
...
func (suite *wsdbCacheTestSuite) TestCacheGroupDeleteDuringRefresh() {
	...
	mockBranchWorkspace(suite.common.mockSess, quantumfs.NullSpaceName,
		quantumfs.NullSpaceName, quantumfs.NullSpaceName, "ts2", "ns2", "a",
		[]byte(nil), nonceA, gocql.ErrNotFound)

	nonceB := GetUniqueNonce()
	mockBranchWorkspace(suite.common.mockSess, quantumfs.NullSpaceName,
		quantumfs.NullSpaceName, quantumfs.NullSpaceName, "ts2", "ns2", "b",
...
func (suite *wsdbCacheTestSuite) TestCacheParentDeleteDuringRefresh() {
	...
	mockBranchWorkspace(suite.common.mockSess, quantumfs.NullSpaceName,
		quantumfs.NullSpaceName, quantumfs.NullSpaceName, "ts", "parentNS",
...
func (suite *wsdbCacheTestSuite) TestCacheConcWsListWhenEmpty() {
	...
	var wsWg sync.WaitGroup
	var wsMap1, wsMap2 map[string]quantumfs.WorkspaceNonce
	wsFetchPause := make(chan bool)
